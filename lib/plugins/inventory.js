...
function inject (bot, { hideErrors }) {
  ...
  async function activateBlock (block, direction, cursorPos, force) {
  ...
  async function openBlock (block, direction, cursorPos, force) {
    bot.activateBlock(block, direction, cursorPos, force)
